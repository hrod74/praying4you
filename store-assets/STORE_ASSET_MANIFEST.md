# Prayer Table Store Asset Manifest v0.2

Status: UPDATED FOR PRAYER TABLE; TECHNICAL VALIDATION PASSED; OWNER VISUAL REVIEW PENDING

Prepared and validated: 2026-09-01
...
| `google-play/feature-graphic-1024x500.png` | Google Play | 1024 x 500 | PNG | RGB | None | 103,202 | Current adaptive icon, palette, Prayer Table name, and approved subtitle | PASS |
...
These five are authentic current-app captures at Apple's accepted 1640 x 2360 portrait size. The Verse capture was refreshed from Prayer Table build 4 on 2026-09-01; the other four were supplied on 2026-08-15 and contain no visible old branding. Apple states that accepted smaller iPad screenshots are scaled for the required 13-inch display if native 13-inch screenshots are not provided. The raw create-request and anonymous-choice files are byte-for-byte identical, so the production set includes that view once and retains both originals.
...
| `apple/screenshots/ipad-11/05-verse-of-the-day.jpg` | JPEG, RGB, none | 155,152 | `screenshots/raw/ios-ipad/06-verse-of-day-prayer-table.jpeg` | PASS |

## Completed Google Play phone screenshots

All six are authentic Pixel 2 Android Emulator captures from Android 16, API 36, at 1080 x 1920 portrait. The Verse capture was refreshed from Prayer Table build 4 on 2026-09-01; the other five were supplied on 2026-08-15 and contain no visible old branding. Export processing only flattened the original opaque alpha channel.
...
| `google-play/screenshots/phone/06-verse-of-the-day.png` | PNG, RGB, none | 151,196 | `screenshots/raw/android-phone/06-verse-of-day-prayer-table.png` | PASS |
...
- Capture dates: 2026-08-15 for the original approved set; 2026-09-01 for the Prayer Table welcome, About, Android Verse, and iPad Verse refreshes.
...
- The 2026-09-01 iPhone welcome and Settings/About captures are archived as portfolio and website sources; they are not part of the six-image production store screenshot sequence.
...
Package v0.1 was approved by the owner on 2026-08-15. Package v0.2 updates visible branding to Prayer Table and awaits final owner visual approval.
